...
export const AuthProvider = ({children})=>{
    ...
    const endpointURL = 'https://py-chat-pk8x.vercel.app/api/token/'
    const endpointRefreshURL = 'https://py-chat-pk8x.vercel.app/api/token/refresh/'
    const endpointRoom = "https://py-chat-pk8x.vercel.app/api/room"
    const endpointMessage = 'https://py-chat-pk8x.vercel.app/api/message'
    const endpointRegister = 'https://py-chat-pk8x.vercel.app/api/user/0'
